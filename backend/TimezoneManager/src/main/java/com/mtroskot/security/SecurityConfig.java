...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	// @formatter:off
		...
		.and().authorizeRequests().antMatchers("/users/changeRole").hasAnyAuthority("USER","MANAGER","ADMIN")
		.and().authorizeRequests().antMatchers("/users/**").hasAnyAuthority("MANAGER","ADMIN")
